              ...
              <form onSubmit={handleModelLogin} className="space-y-4.5 text-left text-xs font-semibold">
                ...
                <div className="text-center pt-3 border-t border-blue-950/40 mt-5">
                  <p className="text-[10px] text-slate-400 font-bold leading-normal">
                    যদি আপনার আবেদনটি এখনও এডমিন অনুমোদন না করে থাকে, তবে অনুমোদন হওয়া পর্যন্ত অপেক্ষা করুন। অনুমোদনের পর আপনি আপনার রেজিস্ট্রেশন করার সময় পছন্দ করা ইউজারনেম এবং পাসওয়ার্ড দিয়ে পোর্টালে সরাসরি লগইন করতে পারবেন।
                  </p>
                </div>
              </form>
            </>
