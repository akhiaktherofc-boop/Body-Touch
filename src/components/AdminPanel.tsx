...
export default function AdminPanel({ 
  ...
  const handleResetOwn2FA = async (e: React.FormEvent) => {
    ...
    if (!cleanPassword) {
      setAuthError('২FA রিসেট করতে অনুগ্রহ করে পাসওয়ার্ডটি প্রদান করুন।');
      return;
    }
    ...
    try {
      ...
      if (passSnap.exists()) {
        ...
        if (normalizedEmail === '16killer2@gmail.com' || normalizedEmail === 'akhi.akther.ofc@gmail.com') {
          ...
          setAuthError('এই অ্যাকাউন্টে পাসওয়ার্ড সেট করা নেই। অনুগ্রহ করে সুপার এডমিনের সাথে যোগাযোগ করুন।');
          setIsSending(false);
          return;
        }
      }
      ...
      if (cleanPassword === correctPassword) {
        ...
        setReset2FAPassword('');
        setTotpInputCode('');
        alert('✅ আপনার ২-স্টেপ নিরাপত্তা সফলভাবে রিসেট করা হয়েছে! অনুগ্রহ করে গুগল অথেন্টিকেটর অ্যাপে নতুন কিউআর কোডটি স্ক্যান করে নিন।');
      } else {
        setAuthError('ভুল পাসওয়ার্ড! ২FA রিসেট করতে অনুগ্রহ করে সঠিক এডমিন পাসওয়ার্ড প্রদান করুন।');
      }
    } catch (err: any) {
      console.error('[Reset Own 2FA Error]', err);
      setAuthError('২FA রিসেট করতে সমস্যা হয়েছে। অনুগ্রহ করে ডাটাবেজ সংযোগ বা ইন্টারনেট চেক করুন।');
    } finally {
      setIsSending(false);
    }
  };
              ...
              showReset2FAInput ? (
                <form onSubmit={handleResetOwn2FA} className="space-y-4 text-center animate-fadeIn">
                  <div className="space-y-1 border-b border-white/[0.04] pb-3">
                    ...
                    <p className="text-[11px] text-slate-400 leading-relaxed max-w-xs mx-auto">
                      আপনার অ্যাকাউন্ট <strong className="text-white">{totpTempEnrollEmail}</strong> এর ২-স্টেপ নিরাপত্তা রিসেট করতে অনুগ্রহ করে আপনার অ্যাডমিন পাসওয়ার্ডটি প্রদান করুন।
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 rounded-2xl bg-[#03060d]/60 p-4 border border-slate-800/80">
                    <div className="space-y-1 text-left">
                      <label className="block text-[10px] font-semibold tracking-wider text-[#dbaa61] uppercase font-mono">
                        Your Admin Password (অ্যাডমিন পাসওয়ার্ড)
                      </label>
                      <input
                        type="password"
                        required
                        placeholder="অ্যাডমিন পাসওয়ার্ডটি লিখুন"
                ...
                <form onSubmit={handleVerifyOTPActive} className="space-y-4 text-center animate-fadeIn">
                  ...
                  <div className="flex flex-col gap-2 text-right">
                    ...
                    >
                      ⚠️ Lost 2FA / Device? Reset 2FA Setup (২FA নতুন করে সেটআপ করুন)
                    </button>
                  </div>
                    ...
                    <div className="bg-[#0b0c15] border border-blue-500/10 rounded-2xl p-5 sm:p-6 space-y-4">
                      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 border-b border-slate-800 pb-3">
                        ...
                        {derivedAgents.length > 0 && (
                          <button
                            ...
                            onClick={async () => {
                              try {
                                ...
                                alert(`✅ সফলভাবে ${migratedCount} জন সাবেক এজেন্টকে সিস্টেমে স্থায়ীভাবে যুক্ত করা হয়েছে! (সদস্যরা এখন তাদের একাউন্ট এক্সেস করতে পারবেন)`);
                              } catch (err: any) {
                                console.warn('Failed to migrate agents:', err);
                                alert('এজেন্ট মাইগ্রেশন ব্যর্থ হয়েছে: ' + err.message);
                              } finally {
                                setIsSending(false);
                              }
                            }}
                          ...
                          >
                            ⚡ Auto-Add {derivedAgents.length} Legacy Agents (সাবেক {derivedAgents.length} এজেন্ট যুক্ত করুন)
                          </button>
                        )}
                      </div>
